                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control"  min="0" name="Nop" id="Nop"  value="${uiList.getNop()}" required/>
                                        </div>
                                    </div>
                                </div>
                                <div id="result"></div>
                                ...
                                <div class="row">                   
                                 ...
                                 <input type="text" name="Yop" id="Yop" class="form-control" placeholder="Enter the year of publish" required></input>                        
                                            ...
                                            <div class="form-group" style="font-size: 13px;">
                                                ...
                                                <input type="number" name="Nop" id="Nop"  min="0" class="form-control" placeholder="Enter the pages" required></input>
                                            </div>
                        ...
                        <form action="UpdateController" method="get" name="book_form">
                            ...
                            <div class="row">                   
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" style="font-size: 13px;">
                                        <label>Title</label>
                                        <input type="text" name="Title" id="editTitle" class="form-control" placeholder="Enter the Title" required></input>
                                    </div>
                                    <div class="form-group" style="font-size: 13px;">
                                        <label>Author</label>
                                        <input type="text" name="Author" id="editAuthor" class="form-control" placeholder="Enter the Author" required></input>
                                    </div>
                                    <div class="form-group" style="font-size: 13px;">
                                        <label>Main</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" style="font-size: 13px;">
                                        <label>Number Of Pages</label>
                                        <input type="text" name="Nop" id="editNop" class="form-control" placeholder="Enter the pages" required></input>
                                    </div>
