	...
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slider Item -->
				<div class="info" style="background-color:#f7f7f7">
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="row info_row">
				...
				<div class="col-lg-3 info_col">
					<div class="info_item text-center">
						<div class="info_image"><a href="ViewBookcontroller"><img src="icon/book.png"  alt=""></a></div>
						<div class="info_title">Add book</div></a>
						<div class="info_text">
					...
					<div class="info_item text-center">
						...
						<div class="info_title">Update Book</div></a>
						<div class="info_text">
                                ...
                                <div class="col-lg-3 info_col">
					<div class="info_item text-center">
						<div class="info_image"><a href="ViewBookcontroller"><img src="icon/deletebook.png"  alt=""></a></div>
						<div class="info_title">Delete Book</div></a>
						<div class="info_text">
				...
				<div class="col-lg-3 info_col">
					<div class="info_item text-center">
						<div class="info_image"><a href="ViewBookcontroller"><img src="icon/x.png" alt=""></a></div>
						<div class="info_title">Search book</div>
						<div class="info_text">
